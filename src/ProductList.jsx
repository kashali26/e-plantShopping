...
function ProductList() {
    ...
    const totalQuantity = useSelector(state => state.cart.items.reduce((total, item) => total + item.quantity, 0)); // Total quantity from Redux state
        ...
        <div>
            ...
            <div style={styleObjUl}>
                ...
                <div> <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}><h1 className='cart'>
                    ...
                    </svg> <span className="cart-quantity">{totalQuantity}</span></h1></a></div>
            </div>
                        ...
                        <button className="product-button"
                            onClick={() => {
                                addedToCart[plant.name]
                                    ? handleRemoveFromCart(plant.name)
